...
- [Python BoilerPlate Code](https://github.com/Tarleton-Computer-Society/hospital-cms-python-boilerplate)
- [Java BoilerPlate Code](https://github.com/Tarleton-Computer-Society/hospital-cms-java-boilerplate)
## GUI Client:
